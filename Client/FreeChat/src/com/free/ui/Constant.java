...
//	public static final String MY_NEWS_DATE = "my.news.date";
	 ...
	 * 服务器的配置
	 */
	public static final String CONFIG = "config";// 登录设置
...
//	public static final String NO_GROUP_FRIEND = "未分组好友";// 所有好友
	 ...
	 * 好友订阅
	 */
	public static final String ACTION_ROSTER_SUBSCRIPTION = "action_roster.subscription";
	/**
	 * 聊天消息
	 */
...
//	public static final int UNKNOWERROR = 2;// 出现未知错误.
//	public static final int NETWORKERROR = 3;// 网络错误
//
//	/***
//	 * 通讯录根据用户id和用户名去查找人员中的请求xml是否包含自组织
//	 */
...
//	public static final String rename = "01";// 重命名
//	public static final String remove = "02";// 删除
//
//	/**
//	 * 重连接状态acttion
//	 * 
